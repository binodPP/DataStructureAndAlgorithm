...
//middle node of the linked list. If there are even nodes,
// then there would be two middle nodes, we need to print the second middle element.
public class FindMiddleElementLinkedList_876 {
    int length=0;
    Node head=null;
    Node tail=null;

    public static void main(String[] args) {
        FindMiddleElementLinkedList_876 findMiddleData1= new FindMiddleElementLinkedList_876();
        ...
        System.out.println("Middle Element is : " + findMiddleData1.findMiddleDataFirstMethod(findMiddleData1.head));
    ...
    public int findMiddleDataFirstMethod(Node findMiddleElementLinkedList){
        ...
        Node temp= findMiddleElementLinkedList;
        while(temp !=null){
            temp=temp.next;
            count++;
        }
